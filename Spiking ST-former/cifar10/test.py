...
parser.add_argument('--dataset', '-d', metavar='NAME', default='/media/data/Spiking_ST_former/torch/cifar10/',
...
parser.add_argument('--resume',
                    default='/media/data/Spiking_ST_former/checkpoint-397.pth.tar',
